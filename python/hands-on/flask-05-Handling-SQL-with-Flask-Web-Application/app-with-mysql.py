...
app.config['MYSQL_DATABASE_PORT'] = 3306 #mysql dısardan databese server ıster herzaman 3306 porttan calısır
mysql = MySQL()
mysql.init_app(app)
...
if __name__ == '__main__':
    app.run(debug=True)
   # app.run(host='0.0.0.0', port=80) ### 3306 porttan dan çalısır herzaman mysql